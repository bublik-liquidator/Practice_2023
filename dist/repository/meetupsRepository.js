...
function getAll(page, size) {
    return __awaiter(this, void 0, void 0, function* () {
        const { rows } = yield dbProvider_1.default.pool.query("SELECT * FROM meetup ORDER BY id OFFSET $1 LIMIT $2", [(page - 1) * size, size]);
        return rows;
    });
}
function getById(id) {
    return __awaiter(this, void 0, void 0, function* () {
        {
            ...
            try {
                const res = yield dbProvider_1.default.pool.query(query);
                return res.rows[0];
            }
            catch (err) {
                loggerr.info(err);
...
function post(meetup) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield dbProvider_1.default.pool.query(query);
